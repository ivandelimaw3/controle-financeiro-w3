        ...
        <table className="w-full">
          <thead className="bg-slate-50 border-b border-slate-200">
            <tr>
              ...
              <th className="text-left p-4 font-semibold text-slate-700">Fonte($)</th>
              <th className="text-left p-4 font-semibold text-slate-700">Lançada</th>
              <th className="text-left p-4 font-semibold text-slate-700">Vence em</th>
