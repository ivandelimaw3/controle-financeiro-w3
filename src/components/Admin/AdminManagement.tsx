...
const AdminManagement: React.FC<AdminManagementProps> = ({
  ...
  // Separar o administrador atual dos outros
  const currentAdmin = admins.find(admin => admin.user_id === currentAdminId);
  const otherAdmins = admins.filter(admin => admin.user_id !== currentAdminId);
            ...
            <div className="bg-blue-50 p-4 rounded-lg">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-blue-900">{currentAdmin.email}</p>
                    <p className="text-sm text-blue-700">
                      Administrador desde {formatDate(currentAdmin.created_at)}
                    </p>
                  </div>
                </div>
        ...
        <CardContent>
          {otherAdmins.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-slate-600">Nenhum outro administrador encontrado</p>
              <p className="text-sm text-slate-500 mt-2">
                Adicione outros administradores para compartilhar as responsabilidades
              </p>
            </div>
          ) : (
